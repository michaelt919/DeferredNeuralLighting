...
class LogIOMapper(IOMapper):
    ...
    def map_input(self, x):
        ...
        y = tf.compat.v1.log(y) # => [-1, log(M + 1/e)]
        y = linear_map(y, -1.0, tf.compat.v1.log(self.M + 1.0 / math.e), -1.0, 1.0) # => [-1, 1]
        return y
    ...
    def map_texture(self, x):
        ...
        y = tf.compat.v1.compat.v1.log(y) #[-1, inf]
        return y
    ...
    """
    def map_output(self, x):
        y = linear_map(x, -1.0, 1.0, -1.0, tf.compat.v1.log(self.M + 1.0 / math.e)) # => [-1, log(M + 1/e)]
